                ...
                <div className="info">
                    ...
                    <div className="price-tag">
                        <div className="flex flex-row">
                            ...
                            <p className="font-semibold text-orange-500 bg-orange-100 rounded-xl px-2 m-2 ">60% off</p>
                        </div>
                        <p className="retail-price">₹149.00</p>
                    </div>
            ...
            >
                ...
                <div className="wrapper">
                    <div className="modal-gallery">
                        ...
                        <div className="photo-options">
                            <button
                                className={`img img-1 ${activeModalImage === Image1 ? "selected" : ""
                                    }`}
                                onClick={() => adjustActiveModalImage(Image1)}
                            ></button>
                            <button
                                className={`img img-2 ${activeModalImage === Image2 ? "selected" : ""
                                    }`}
                                onClick={() => adjustActiveModalImage(Image2)}
                            ></button>
                            <button
                                className={`img img-3 ${activeModalImage === Image3 ? "selected" : ""
                                    }`}
                                onClick={() => adjustActiveModalImage(Image3)}
                            ></button>
                            <button
                                className={`img img-4 ${activeModalImage === Image4 ? "selected" : ""
                                    }`}
