        ...
        <div className="relative min-h-fit">
            <div className="flex items-center justify-center">
                <div className="text-center text-white p-4 md:p-8 w-full md:w-2/3">
                    ...
                    <div className='mt-6 md:mt-24 md:mb-14'>
